 ...
 */
$config['site_title']                 = "Studentattender";       // Site Title, example.com
$config['admin_email']                = "fokiratonmoy@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name
$config['admin_group']                = 'admin';
$config['cooks_group']                = 'cook';             // Default administrators group, use name
$config['identity']                   = 'email';             // A database column which is used to login with
$config['identity_alt']               = 'eiin_number';          // A secondary column that can be used to identify the user
...
$config['email_config'] = array(
  ...
  'smtp_user' =>'shtonmoy007@gmail.com',
  'smtp_pass' => 'shoileetonmoy',
  'smtp_port' => 465,
  'crlf' => "\r\n",
  'newline' => "\r\n",
   'mailtype'=>'html'
...
$config['message_start_delimiter'] = '<p class="alert alert-success" role="alert"> <button type="button" class="close" data-dismiss="alert"><i class="fa fa-times-circle"></i></button>'; 	// Message start delimiter
$config['message_end_delimiter']   = '</p>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<p class="alert alert-danger" role="alert"><button type="button" class="close" data-dismiss="alert"><i class="fa fa-times-circle"></i></button>';		// Error message start delimiter
